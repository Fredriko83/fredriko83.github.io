...
This also means that i don't have to finish a template or be sure about my design before i can start working on content because
...
with regular HTML/CSS but in the end it had changed to the opposite, I tried things I wouldn't have time/the energy to try in
regular HTML/CSS.
